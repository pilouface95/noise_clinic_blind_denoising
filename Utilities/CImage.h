...
class CImage {
  ...
  public:
    ...
    */
    ...
    //! Checks if all channels in the image contain the same values
    /*!
      \param channel Channel index (0, 1, ...)
      \return True is the channels of the image are equal or false otherwise
    */
    bool channels_are_equal();
